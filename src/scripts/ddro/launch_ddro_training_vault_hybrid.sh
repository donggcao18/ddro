...
# Additive hybrid launcher. Existing BM25-only launchers are intentionally unchanged.
...
TRAIN_FILE="${TRAIN_FILE:-/home/users/congthanh_le/scratch/east/ddro/data/vault_bm25/dpo_pairs_hybrid.jsonl}"
OUTPUT_DIR="${OUTPUT_DIR:-/home/users/congthanh_le/scratch/east/ddro/outputs/vault-ruby-ddro-hybrid-prompt256-id20}"
NUM_GPUS="${NUM_GPUS:-1}"
